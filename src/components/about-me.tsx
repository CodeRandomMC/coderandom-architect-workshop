  ...
  return (
    <section id="about" className="py-20 md:py-28 bg-card/50">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-primary">About The Architect</h2>
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-16">
          <Avatar className="w-48 h-48 md:w-64 md:h-64 border-4 border-primary/80 shadow-lg">
            <AvatarImage src="https://placehold.co/400x400.png" alt="Headshot" data-ai-hint="architect portrait" />
